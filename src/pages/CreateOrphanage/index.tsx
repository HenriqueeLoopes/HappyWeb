...
export default function CreateOrphanage() {
  ...
  function handleRemoveImage(image: string){
    function isDifferent(value: string) {
      return value !== image;
    }
    
    var filtered = previewImages.filter(isDifferent);
            ...
            <div className="input-block">
              ...
              <div className="images-container">
                {previewImages.map((image, imageIndex) => {
                  return (
                    <div key={imageIndex} className="img-container">
                      <img src={image} alt={name} />
                      <button type="button" className="remove-item" onClick={() => handleRemoveImage(image)}>
                        <FiTrash color="#FF669D" size={18} />
                      </button>
                    </div>
                  );
                })}
